...
7 de septiembre de 2026. Partidas jugadas por bots con criterio de jugador razonable sobre el prototipo M0 v0.3: 40 partidas por misión y tamaño de grupo (2 y 4 jugadores), más 20 con 10 jugadores como referencia. Antes de la tanda final se leyeron partidas completas de cada misión para entender por qué se perdían, y se corrigió lo que era un defecto de diseño y no una torpeza del bot.
